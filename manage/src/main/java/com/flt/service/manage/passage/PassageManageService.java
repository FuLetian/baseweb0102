package com.flt.service.manage.passage;
...
@Service
public class PassageManageService extends BaseManageService implements IPassageService ,IPassageManageService{
	...
	@Override
	public void saveOrUpdatePassage(Integer passageNum, String text,Integer userId) {
		// TODO Auto-generated method stub
		PassageMapper m=this.getSqlSession().getMapper(PassageMapper.class);
