...
public class BasewebApplicationContext implements ApplicationContextAware,ICommonStaticWebService {
	...
	public void setApplicationContext(ApplicationContext applicationContext)
		...
		BasewebApplicationContext.applicationContext=applicationContext;
	}

	@Override
	public void staticweb(Integer userId,HttpServletRequest req) {
		// TODO Auto-generated method stub
		Map<String, HTMLAbled> controllerMap= BasewebApplicationContext.applicationContext.getBeansOfType(HTMLAbled.class);
